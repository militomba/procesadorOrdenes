package ar.edu.um.programacion2.procesadorordenes.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        ar.edu.um.programacion2.procesadorordenes.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        ar.edu.um.programacion2.procesadorordenes.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        ar.edu.um.programacion2.procesadorordenes.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "ar.edu.um.programacion2.procesadorordenes"
        );
    }
}
